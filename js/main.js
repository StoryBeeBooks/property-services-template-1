document.addEventListener("DOMContentLoaded", function() {
    ...
    fetch('components/header.html')
        ...
        .then(data => {
            ...
            initMobileMenu();
            initLanguageSwitcher(); // Initialize language switcher after header loads
            applyTranslations(); // Apply translations to header
        });
    ...
    fetch('components/footer.html')
        ...
        .then(data => {
            ...
            applyTranslations(); // Apply translations to footer
        });

    initComparisonSliders();
    initFAQ();
    
    // Initial translation application for static content
    applyTranslations();
});
